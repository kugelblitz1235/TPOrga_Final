...
Alignment* alignment_by_SW(std::string implementation, char * sequence_1, char* sequence_2, short gap, short missmatch, short match){
	...
	if(implementation.compare("C_LIN") == 0) LIN::SW_C_LIN(*alignment, true);
	else if(implementation.compare("C_SSE") == 0)SSE::SW_C_SSE(*alignment, true);
	else if(implementation.compare("C_AVX") == 0)AVX::SW_C_AVX(*alignment, true);
