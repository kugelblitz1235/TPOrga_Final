...
ggsave("graficos/NW_random_t_c.png", width = 8, height = 5)
...
ggsave("graficos/NW_random_t_l.png", width = 8, height = 5)
...
ggsave("graficos/NW_random_gcups_c.png", width = 8, height = 5)
...
ggsave("graficos/NW_random_gcups_l.png", width = 8, height = 5)
...
ggsave("graficos/SW_random_t_c.png", width = 8, height = 5)
...
ggsave("graficos/SW_random_t_l.png", width = 8, height = 5)
...
ggsave("graficos/SW_random_gcups_c.png", width = 8, height = 5)
...
ggsave("graficos/SW_random_gcups_l.png", width = 8, height = 5)
...
ggsave("graficos/NW_genomes_t.png", width = 8, height = 5)
...
ggsave("graficos/NW_genomes_gcups.png", width = 8, height = 5)
...
ggsave("graficos/SW_reads_t.png", width = 8, height = 5)
...
ggsave("graficos/SW_reads_gcups.png", width = 8, height = 5)
